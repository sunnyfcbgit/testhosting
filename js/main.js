...
(() => {
  ...
  document.addEventListener("click", event => {
    if (event.target.classList.contains("link-item")) {
      /* make sure event.targethash has value before overridding default behavior*/
...
(() => {
  ...
  function popupDetails() {
    ...
    // get the porject title
    const tilte = portfolioItems[itemIndex].querySelector(
      ".portfolio-item-title"
    ).innerHTML;
    // set the project tilte
    popup.querySelector(".pp-title h2").innerHTML = tilte;
...
(() => {
  const sliderContainer = document.querySelector(".testi-slider-container"),
    ...
    nextvBtn = document.querySelector(".testi-slider-nav .next"),
